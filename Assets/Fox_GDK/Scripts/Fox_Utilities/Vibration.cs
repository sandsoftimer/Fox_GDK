...
namespace RDG
{
    ...
    public static class Vibration
    {
            ...
            if (isInitialized == false && Application.platform == RuntimePlatform.Android)
            {
                ...
                using (AndroidJavaObject currentActivity = unityPlayer.GetStatic<AndroidJavaObject>("currentActivity"))
                {
                    if (currentActivity != null)
                    {
                        ...
                        // if device supports vibrationEffectOn effects, get corresponding class
        ...
        /// </summary>
        public static void Vibrate(long milliseconds = 15, int amplitude = -1, bool cancel = false)
        {
        ...
        /// <summary>
        /// Tries to cancel current vibrationEffectOn
        /// </summary>
